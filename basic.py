...
def savings(gross_pay, tax_rate, expenses):
    ...
    def savings(gross_pay, tax_rate, expenses):
        ...
        Returns = int((gross_pay*(1-tax_rate)//1)-expenses)
        return Returns
...
def material_waste(total_material, material_units, num_jobs, job_consumption):
    ...
    def material_waste(total_material, material_units, num_jobs, job_consumption):
        ...
        Returns = str(total_material-num_jobs*job_consumption)+str(material_units)
        return Returns
...
def interest(principal, rate, periods):
    ...
    def interest(principal, rate, periods):
        ...
        rate = float(rate)
        periods = int(periods)
        Returns = int(principal*rate*periods+principal)
        return Returns
